...
while True:
    ...
    for object_id, pt2 in tracking_objects_copy.items():
        ...
        for (pt,i) in center_points_cur_frame_copy:
            ...
            print(distance, "x previous", pt2[0], "x current", pt[0], " object ID: ", object_id)
            print(distance, "y previous", pt2[1], "y current", pt[1], " object ID: ", object_id)
    ...
    for (pt,i) in center_points_cur_frame:
        ...
        object_name = labels[int(classes[i])]
        print("New object is detected", track_id, " is ", object_name)
        track_id += 1
